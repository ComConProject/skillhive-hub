...
-- providing_service
CREATE TABLE IF NOT EXISTS public.providing_service(
    id integer generated by default as identity primary key,
    title TEXT,
    description TEXT,
    created_at TIMESTAMPTZ DEFAULT now(),
...
CREATE TABLE IF NOT EXISTS public.pricing(
    ...
    service_id int8 references public.providing_service(id),
    meta_data JSONB,
    type_id int4 references public.term(id),
    user_id UUID,
...
-- stripe_webhook
CREATE TABLE IF NOT EXISTS public.stripe_webhook(
    id integer generated by default as identity primary key,
    receipt_email text,
    data JSONB,
    created_at TIMESTAMPTZ DEFAULT now(),
